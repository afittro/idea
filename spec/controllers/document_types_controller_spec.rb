...
RSpec.describe DocumentTypesController, type: :controller do
  ...
  # Document Type. As you add validations to Document Type, be sure to
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created document type" do
        post :create, params: {document_type: valid_attributes}, session: valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested document type" do
        document_type = DocumentType.create! valid_attributes
      ...
      it "redirects to the document type" do
        document_type = DocumentType.create! valid_attributes
  ...
  describe "DELETE #destroy" do
    it "destroys the requested document type" do
      document_type = DocumentType.create! valid_attributes
      expect {
        delete :destroy, params: {id: document_type.to_param}, session: valid_session
      }.to change(document_type, :count).by(-1)
    end

    it "redirects to the document types list" do
      document_type = DocumentType.create! valid_attributes
      delete :destroy, params: {id: document_type.to_param}, session: valid_session
